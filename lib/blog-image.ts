const R2_BASE = 'https://pub-ee5d8554679a4a23a82caac56686992a.r2.dev/monptitdepanneur'

/**
 * Resolves a blog post cover_image_url to an absolute URL.
 *
 * Patterns found in Supabase:
 * - "/blog-images/filename.webp"  → R2_BASE + "/filename.webp" (strip /blog-images prefix)
 * - "/other/path.webp"            → R2_BASE + "/other/path.webp"
 * - "https://...r2.dev/..."       → use as-is
